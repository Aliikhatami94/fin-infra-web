...
export default function InsightsLoading() {
  return (
  <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-10 space-y-6 py-6" aria-busy>
      <div className="sticky top-0 -mx-4 mb-6 border-b border-border/20 bg-card/90 px-4 py-4 backdrop-blur-md sm:-mx-6 lg:-mx-10">
