          ...
          <section className="relative px-6 pt-32 pb-24 lg:px-8 lg:pt-40">
            ...
            >
              <div className="text-center">
                ...
                <div
                  className={cn(
                    "mt-10 flex flex-col items-center justify-center gap-6 text-sm text-muted-foreground sm:flex-row transition-opacity duration-700 ease-[var(--ease-standard)]",
