          ...
          <div className="flex justify-between items-start gap-2">
            ...
            {kpi.change !== undefined && (
              <div className={cn("flex items-center px-2 py-0.5 rounded-md text-[11px] font-semibold", 
                kpi.change >= 0 ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-500" : "bg-rose-500/10 text-rose-600 dark:text-rose-500"
              )}>
        ...
        >
          <CarouselContent className="-ml-4 pt-4">
            {kpiCards.map((kpi, index) => (
              <CarouselItem key={kpi.id} className="pl-4 basis-[57%] sm:basis-[44%]">
